...
export default function DeleteComment({ blogs, fetchData, comments }) {
    ...
    const removeToggle = async () => {
        ...
        if (result.isConfirmed) {
            ...
            try {
                const response = await fetch(`${import.meta.env.VITE_API_URL}/blogs/deleteBlogComment/${blogs}/${comments}`, {
                    method: 'DELETE',
                    headers: {
